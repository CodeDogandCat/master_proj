...
package cn.edu.hfut.lilei.shareboard.widget.refreshandload;
 ...
 * contents of a btnStart via a vertical swipe gesture. The activity that
 * instantiates this btnStart should add an OnRefreshListener to be notified
 ...
 * progress animation, call setEnabled(false) on the btnStart.
 * 
 * <p>
 * This layout should be made the parent of the btnStart that will be refreshed as a
 * result of the gesture and can only support one direct child. This btnStart will
...
public class SwipeRefreshLayout extends ViewGroup {
	 ...
	 * 
	 * @param refreshing
	 *            Whether or not the btnStart should show refresh progress.
	 */
	...
	/**
	 * @return Whether it is possible for the child btnStart of this layout to
	 *         scroll up. Override this if the child btnStart is a custom btnStart.
	 */
			...
			if (mIsBeingDragged) {
				...
				if (yDiff > mDistanceToTriggerSync) {
					...
					if (mTarget.getTop() == getPaddingTop()) {
						// If the user puts the btnStart back at the top, we
	...
	public static enum Mode {
		...
		// The modeInt values need to match those from attr.xml
		Mode(int modeInt) {
			mIntValue = modeInt;
		}
