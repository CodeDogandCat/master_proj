...
import cn.edu.hfut.lilei.shareboard.adapter.EmotionGridViewAdapter;
import cn.edu.hfut.lilei.shareboard.adapter.EmotionPagerAdapter;
import cn.edu.hfut.lilei.shareboard.base.BaseFragment;
import cn.edu.hfut.lilei.shareboard.base.MyApplication;
import cn.edu.hfut.lilei.shareboard.utils.EmotionUtils;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private GridView createEmotionGridView(List<String> emotionNames, int gvWidth, int padding, int itemWidth, int gvHeight) {
        ...
        EmotionGridViewAdapter
                adapter = new EmotionGridViewAdapter(getActivity(), emotionNames, itemWidth);
