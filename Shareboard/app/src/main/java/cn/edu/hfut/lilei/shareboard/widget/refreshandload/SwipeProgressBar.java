...
//        final int cy = height / 2;
        ...
        if (mRunning || (mFinishTime > 0)) {
            ...
            if (!mRunning) {
                ...
                // this refreshing btnStart that needs to be filled in by the
                // trigger. If the progress btnStart is just still animating, let it
                // continue animating.
    ...
    /**
     * Draws a circle centered in the btnStart.
     *
     * @param canvas the canvas to draw on
     * @param cx the center x coordinate
     * @param cy the center y coordinate
     * @param color the color to draw
     * @param pct the percentage of the btnStart that the circle should cover
     */
