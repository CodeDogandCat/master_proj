...
import cn.edu.hfut.lilei.shareboard.activity.PermissionActivity;
...
public class PermissionsUtil {
     ...
     */
    public static void requestPermission(Activity activity, PermissionListener listener,
                                         String[] permissions) {
    ...
    public static void requestPermission(@NonNull Activity activity,
                                         ...
                                         @NonNull String[] permissions, boolean showTip,
